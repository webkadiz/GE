  ...
  var colpick = (function() {
    var tpl =
      ...
      setHue = function(hsb, cal) {
        $(cal)
          .data("colpick")
          .hue.css("top", parseInt($(cal).data("colpick").height - $(cal).data("colpick").height * hsb.h / 360, 10));
      },
      ...
      change = function() {
        ...
        cal
          .data("colpick")
          .onChange.apply(cal.parent(), [col, hsbToHex(col), hsbToRgb(col), cal.data("colpick").el, 0]);
      },
      ...
      downHue = function(ev) {
        ...
        change.apply(
          current.cal
            ...
            .val(
              parseInt(
                360 * (current.cal.data("colpick").height - (pageY - current.y)) / current.cal.data("colpick").height,
                10
              )
            )
            .get(0),
        ...
        change.apply(
          current.cal
            ...
            .val(
              parseInt(
                100 *
                  (current.cal.data("colpick").height - (pageY - current.pos.top)) /
        ...
        change.apply(
          ev.data.cal
            ...
            .val(
              parseInt(
                100 *
                  Math.max(0, Math.min(ev.data.cal.data("colpick").height, pageX - ev.data.pos.left)) /
                  ev.data.cal.data("colpick").height,
                10
              )
            )
      ...
      setColor: function(col, setCurrent) {
        ...
        return this.each(function() {
          if ($(this).data("colpickId")) {
            ...
            cal
              .data("colpick")
              .onChange.apply(cal.parent(), [col, hsbToHex(col), hsbToRgb(col), cal.data("colpick").el, 1]);
            if (setCurrent) {
              setCurrentColor(col, cal.get(0));
            }
          }
